    ...
    <div className="min-h-screen bg-background text-foreground flex flex-col relative overflow-hidden">
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-6 text-center max-w-6xl mx-auto pb-20 z-10 pt-20">
        ...
        <h1 className="text-5xl sm:text-7xl md:text-8xl font-black mb-8 tracking-tight leading-[1.1] text-white drop-shadow-2xl">
          O futuro da <br/>
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary via-purple-400 to-blue-500">avaliação digital.</span>
        </h1>
        
        <p className="text-xl text-muted-foreground mb-12 max-w-2xl leading-relaxed font-light">
          Segurança, design e performance para o ensino moderno. Transforme testes em experiências de aprendizado mensuráveis.
        </p>

        <div className="flex flex-col sm:flex-row gap-5 w-full justify-center mb-24">
          <Link href="/auth/login?role=teacher">
            <Button size="lg" className="h-14 px-8 text-lg font-bold rounded-xl shadow-[0_0_40px_-10px_rgba(124,58,237,0.5)] hover:shadow-[0_0_60px_-10px_rgba(124,58,237,0.6)] hover:scale-105 transition-all w-full sm:w-auto bg-primary text-white border-none">
          ...
          <Link href="/auth/login?role=student">
            <Button size="lg" variant="outline" className="h-14 px-8 text-lg font-bold rounded-xl border-white/20 bg-white/5 backdrop-blur-sm text-white hover:bg-white/10 hover:text-white hover:border-white/40 w-full sm:w-auto transition-all">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-left w-full">
          <div className="group p-8 rounded-3xl bg-secondary/30 border border-white/5 backdrop-blur-md hover:bg-secondary/50 transition-all hover:border-primary/30">
            ...
            <p className="text-muted-foreground leading-relaxed">Interface otimizada para foco total e carregamento instantâneo, sem distrações.</p>
          </div>
          <div className="group p-8 rounded-3xl bg-secondary/30 border border-white/5 backdrop-blur-md hover:bg-secondary/50 transition-all hover:border-primary/30">
            ...
            <p className="text-muted-foreground leading-relaxed">Sistema de tentativa única e controle de tempo preciso para avaliações justas.</p>
          </div>
          <div className="group p-8 rounded-3xl bg-secondary/30 border border-white/5 backdrop-blur-md hover:bg-secondary/50 transition-all hover:border-primary/30">
            ...
            <p className="text-muted-foreground leading-relaxed">Dados estruturados de acertos e erros para acompanhamento pedagógico.</p>
          </div>
        </div>
      </main>
    </div>
